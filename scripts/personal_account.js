const buttonDeleteStoryCard = document.querySelector('.personal-story__button-delete');
const popupDeleteStoryCard = document.querySelector('.popup-delete-story-card');
const buttonCancelDeleteStoryCard = document.querySelector('.popup-delete-story-card__button-cancel');
...
const buttonFormMarkGreat = document.querySelector('.story-form__mark_type_great');
const buttonFormMarkNormal = document.querySelector('.story-form__mark_type_normal');
...
buttonFormMarkGreat.addEventListener('click', ()=>{
  ...
  if (buttonFormMarkGreat.classList.contains("story-form__mark_type_great-active")) {
    ...
    buttonFormMarkNormal.classList.remove('story-form__mark_type_normal-active');
...
buttonFormMarkNormal.addEventListener('click', ()=>{
  ...
  if (buttonFormMarkNormal.classList.contains("story-form__mark_type_normal-active")) {
...
buttonFormMarkBad.addEventListener('click', ()=>{
  ...
  if (buttonFormMarkBad.classList.contains("story-form__mark_type_bad-active")) {
