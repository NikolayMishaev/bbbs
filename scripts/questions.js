...
const questionsCategory = document.querySelectorAll(
  ".block-questions__category"
);
...
buttonsQuestionTitle.forEach((button, i) => {
  button.addEventListener("click", () => {
    ...
    questionsCategory[i].classList.toggle(
      "block-questions__category_style_on-answer"
    );
  });
});
